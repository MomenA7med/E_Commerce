...
import com.example.momen.e_commerceapp.Adpter.ProductViewHolder;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userNameTextView.setText(Prevalent.myAccount.getName());
        Picasso.with(this).load(Prevalent.myAccount.getImage()).placeholder(R.drawable.profile).into(profileImageView);
