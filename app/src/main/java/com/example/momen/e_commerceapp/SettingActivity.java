...
public class SettingActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo()
    {
        ...
        ref.child(Prevalent.myAccount.getPhone()).updateChildren(userMap);
    ...
    private void uploadImage()
    {
        ...
        if (imageUri != null)
        {
            final StorageReference fileRef = storageProfilePrictureRef
                    .child(Prevalent.myAccount.getPhone() + ".jpg");
    ...
    {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance().getReference().child("Users").child(Prevalent.myAccount.getPhone());
